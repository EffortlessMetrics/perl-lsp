...
Metrics in this project are **computed, not hand-edited**. The evidence surface is [`docs/CURRENT_STATUS.md`](docs/CURRENT_STATUS.md), auto-generated by `scripts/update-current-status.py`.
...
- Use qualitative descriptions ("fast", "comprehensive", "full coverage") and link to `docs/CURRENT_STATUS.md` for evidence
- Links to `docs/CURRENT_STATUS.md` in `README.md` must use absolute URLs (`https://github.com/EffortlessMetrics/perl-lsp/blob/master/docs/CURRENT_STATUS.md`) for portability
...
- `docs/CURRENT_STATUS.md` — auto-generated sections between `<!-- BEGIN -->` / `<!-- END -->` markers
