...
enum Commands {
    ...
    /// Enforce workflow security and policy lint rules.
    WorkflowPolicyLint {
        /// Optional single workflow file to lint as a fixture.
        #[arg(long)]
        fixture: Option<PathBuf>,

        /// Optional JSON receipt output path.
        #[arg(long)]
...
fn main() -> Result<()> {
    ...
    match cli.command {
        ...
        Commands::WorkflowPolicyLint { fixture, receipt } => {
