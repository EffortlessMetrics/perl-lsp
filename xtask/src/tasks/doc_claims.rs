...
const STALE_PATTERNS: &[(&str, &str, &str)] = &[
    (
        "563,228 lines",
        "591,034 lines",
        "LOC claim (563K is stale; ledger: 591,034)",
    ),
    (
        "563K lines",
        "591K lines",
        "LOC claim (563K is stale; ledger: 591K)",
    ),
    (
        "546,000",
        "591,034",
        "LOC claim (546K is stale; ledger: 591,034)",
    ),
    (
        "546K lines",
        "591K lines",
        "LOC claim (546K is stale; ledger: 591K)",
    ),
    (
        "131 crates",
        "133 crates",
        "Crate count (131 is stale; ledger: 133)",
    ),
    (
        "131 workspace crates",
        "133 workspace crates",
        "Crate count (131 is stale; ledger: 133)",
    ),
    (
        "132 workspace crates",
        "133 workspace crates",
        "Crate count (132 is stale; ledger: 133)",
    ),
    (
        "132 crates",
        "133 crates",
    ...
    (
        "97 features governed",
        "98 features governed",
        "Feature count (97 is stale; ledger: 98)",
    ),
    (
        "97 features:",
    ...
    (
        "2,700+ commits",
        "3,200+ commits",
        "Commit count (2,700+ is stale; ledger: 3,210)",
    ),
    (
        "2,200+ pull requests",
        "2,646+ pull requests",
...
pub fn run() -> Result<()> {
    ...
    if !articles_dir.is_dir() {
        bail!(
            "expected articles directory not found at {}",
