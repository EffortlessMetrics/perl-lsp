# perl-dap-variables Roadmap

> **Note:** This is the component-specific roadmap for `perl-dap-variables`. For the project-wide roadmap, see [`docs/project/ROADMAP.md`](../../docs/project/ROADMAP.md).
