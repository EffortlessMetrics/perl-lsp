...
impl<'a> Parser<'a> {
    ...
    fn parse_program(&mut self) -> Result<Node, ParseError> {
        ...
        while !self.is_at_end() {
            ...
            if self.match_token(&TokenType::Whitespace) || 
    ...
    fn parse_statement(&mut self) -> Result<Node, ParseError> {
        ...
        if self.match_keyword("my") || self.match_keyword("our") || 
           self.match_keyword("local") || self.match_keyword("state") {
