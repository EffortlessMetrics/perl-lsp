# perl-module-boundary Roadmap

> **Note:** This is the component-specific roadmap for `perl-module-boundary`. For the project-wide roadmap, see [`docs/project/ROADMAP.md`](../../docs/project/ROADMAP.md).
