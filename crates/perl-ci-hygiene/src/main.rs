...
#[cfg(test)]
use crate::commands::githooks::pre_push_hook_script;
use crate::process::*;
...
fn run() -> Result<i32> {
    ...
    let code = match cli.command {
        ...
        CliCommand::GenerateBadges { check } => {
            commands::badges::generate_badges(&repo_root, check)?
        }
        CliCommand::InstallGithooks => commands::githooks::install_githooks(&repo_root)?,
