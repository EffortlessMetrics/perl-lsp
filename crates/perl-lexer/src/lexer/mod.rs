...
use crate::checkpoint::{Checkpointable, LexerCheckpoint};
use crate::config::LexerConfig;
use crate::heredoc::HeredocSpec;
use crate::keywords::is_lexer_keyword;
use crate::limits::{
    HEREDOC_TIMEOUT_MS, MAX_DELIM_NEST, MAX_HEREDOC_BYTES, MAX_HEREDOC_DEPTH,
    MAX_REGEX_BYTES, MAX_REGEX_PARSE_STEPS,
};
