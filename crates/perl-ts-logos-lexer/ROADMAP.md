# perl-ts-logos-lexer Roadmap

> **Note:** This is the component-specific roadmap for `perl-ts-logos-lexer`. For the project-wide roadmap, see [`docs/ROADMAP.md`](../../docs/ROADMAP.md).
