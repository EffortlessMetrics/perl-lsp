...
"#;
        ...
        let decls = provider.find_declaration(code.find("my $x = FOO").unwrap() + 8, 0).unwrap_or_default();
...
"#;
        ...
        let decls = provider.find_declaration(code.find("my $x = BAR").unwrap() + 8, 0).unwrap_or_default();
...
"#;
    ...
    fn test_unicode_constant_names() {
        ...
        let decls = provider.find_declaration(code.find("2 * π").unwrap() + 4, 0).unwrap_or_default();
...
"#;
        ...
        let decls = provider.find_declaration(code.find("Foo::BAR").unwrap() + 5, 0).unwrap_or_default();
