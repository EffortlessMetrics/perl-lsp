use perl_parser::{
    ...
    code_actions_provider::{CodeActionsProvider as CodeActionsProviderV2, CodeActionKind as CodeActionKindV2},
};
...
fn test_unused_variable_quick_fix() {
    ...
    // Check rename action
    let rename_action = actions.iter()
...
fn test_variable_shadowing_quick_fix() {
    ...
    assert!(has_inner || has_local || has_numbered, 
