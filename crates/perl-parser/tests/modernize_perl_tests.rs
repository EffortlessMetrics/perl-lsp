...
mod modernize_perl_tests {
    ...
    fn test_modernize_defined_array() {
        ...
        let suggestion = &suggestions[0];
        assert_eq!(suggestion.description, "defined(@array) is deprecated, use @array in boolean context");
    ...
    fn test_modernize_indirect_object_notation() {
        ...
        let suggestion = &suggestions[0];
        assert_eq!(suggestion.description, "Use direct method call instead of indirect object notation");
    ...
    fn test_modernize_each_on_array() {
        ...
        let suggestion = &suggestions[0];
        assert_eq!(suggestion.description, "each(@array) can cause unexpected behavior, use foreach with index");
    ...
    fn test_modernize_use_strict_warnings() {
        ...
        let suggestion = &suggestions[0];
        assert_eq!(suggestion.description, "Add 'use strict' and 'use warnings' for better code quality");
    ...
    fn test_modernize_say_instead_of_print() {
        ...
        let suggestion = &suggestions[0];
        assert_eq!(suggestion.description, "Use 'say' instead of print with \\n (requires use feature 'say')");
