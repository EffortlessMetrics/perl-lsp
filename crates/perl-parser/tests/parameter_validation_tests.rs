...
"#;
    ...
    let shadow_warnings: Vec<_> = diagnostics.iter()
...
"#;
    ...
    let unused_warnings: Vec<_> = diagnostics.iter()
...
"#;
    ...
    let bareword_errors: Vec<_> = diagnostics.iter()
...
"#;
    ...
    let false_positives: Vec<_> = diagnostics.iter()
