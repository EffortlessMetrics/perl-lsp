...
/// Read-only semantic query facade types and entry-point.
pub use semantic_query::{
    DefinitionId, DefinitionLocation, EffectivePragmaState, ParentChain, ResolvedSymbol,
    SemanticQueryFacade, VisibleImport,
};
