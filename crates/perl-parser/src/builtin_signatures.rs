...
pub fn create_builtin_signatures() -> HashMap<&'static str, BuiltinSignature> {
    ...
    signatures.insert("say", BuiltinSignature {
        signatures: vec![
            "say FILEHANDLE LIST",
            "say FILEHANDLE",
            "say LIST",
    ...
    signatures.insert("close", BuiltinSignature {
        signatures: vec![
            "close FILEHANDLE",
            "close",
        ],
    ...
    signatures.insert("read", BuiltinSignature {
        signatures: vec![
    ...
    signatures.insert("sysread", BuiltinSignature {
        signatures: vec![
    ...
    signatures.insert("write", BuiltinSignature {
        signatures: vec![
            "write FILEHANDLE",
            "write",
        ],
    ...
    signatures.insert("syswrite", BuiltinSignature {
        signatures: vec![
    ...
    signatures.insert("seek", BuiltinSignature {
        signatures: vec![
    ...
    signatures.insert("tell", BuiltinSignature {
        signatures: vec![
            "tell FILEHANDLE",
            "tell",
        ],
    ...
    signatures.insert("eof", BuiltinSignature {
        signatures: vec![
            "eof FILEHANDLE",
            "eof",
        ],
    ...
    // ===== String Functions =====
    signatures.insert("chomp", BuiltinSignature {
        signatures: vec![
            "chomp VARIABLE",
            "chomp LIST",
            "chomp",
    ...
    signatures.insert("chop", BuiltinSignature {
        signatures: vec![
            "chop VARIABLE",
            "chop LIST",
            "chop",
    ...
    signatures.insert("chr", BuiltinSignature {
        signatures: vec![
            "chr NUMBER",
            "chr",
        ],
    ...
    signatures.insert("ord", BuiltinSignature {
        signatures: vec![
            "ord EXPR",
            "ord",
        ],
    ...
    signatures.insert("hex", BuiltinSignature {
        signatures: vec![
            "hex EXPR",
            "hex",
        ],
    ...
    signatures.insert("oct", BuiltinSignature {
        signatures: vec![
            "oct EXPR",
            "oct",
        ],
    ...
    signatures.insert("length", BuiltinSignature {
        signatures: vec![
            "length EXPR",
            "length",
        ],
    ...
    signatures.insert("index", BuiltinSignature {
        signatures: vec![
    ...
    signatures.insert("rindex", BuiltinSignature {
        signatures: vec![
    ...
    signatures.insert("sprintf", BuiltinSignature {
        signatures: vec![
            "sprintf FORMAT, LIST",
        ],
    ...
    signatures.insert("lc", BuiltinSignature {
        signatures: vec![
            "lc EXPR",
            "lc",
        ],
    ...
    signatures.insert("lcfirst", BuiltinSignature {
        signatures: vec![
            "lcfirst EXPR",
            "lcfirst",
        ],
    ...
    signatures.insert("uc", BuiltinSignature {
        signatures: vec![
            "uc EXPR",
            "uc",
        ],
    ...
    signatures.insert("ucfirst", BuiltinSignature {
        signatures: vec![
            "ucfirst EXPR",
            "ucfirst",
        ],
    ...
    signatures.insert("quotemeta", BuiltinSignature {
        signatures: vec![
            "quotemeta EXPR",
            "quotemeta",
        ],
    ...
    signatures.insert("reverse", BuiltinSignature {
        signatures: vec![
            "reverse LIST",
        ],
    ...
    signatures.insert("shift", BuiltinSignature {
        signatures: vec![
            "shift ARRAY",
            "shift",
        ],
    ...
    signatures.insert("unshift", BuiltinSignature {
        signatures: vec![
            "unshift ARRAY, LIST",
        ],
    ...
    signatures.insert("splice", BuiltinSignature {
        signatures: vec![
    ...
    // ===== Hash Functions =====
    signatures.insert("each", BuiltinSignature {
        signatures: vec![
            "each HASH",
            "each ARRAY",
        ],
    ...
    signatures.insert("keys", BuiltinSignature {
        signatures: vec![
            "keys HASH",
            "keys ARRAY",
        ],
    ...
    signatures.insert("values", BuiltinSignature {
        signatures: vec![
            "values HASH",
            "values ARRAY",
        ],
    ...
    // ===== File Test Operators =====
    signatures.insert("stat", BuiltinSignature {
        signatures: vec![
            "stat FILEHANDLE",
            "stat EXPR",
            "stat",
    ...
    signatures.insert("lstat", BuiltinSignature {
        signatures: vec![
            "lstat FILEHANDLE",
            "lstat EXPR",
            "lstat",
    ...
    // ===== Directory Functions =====
    signatures.insert("opendir", BuiltinSignature {
        signatures: vec![
    ...
    signatures.insert("readdir", BuiltinSignature {
        signatures: vec![
            "readdir DIRHANDLE",
        ],
    ...
    signatures.insert("closedir", BuiltinSignature {
        signatures: vec![
            "closedir DIRHANDLE",
        ],
    ...
    signatures.insert("rewinddir", BuiltinSignature {
        signatures: vec![
            "rewinddir DIRHANDLE",
        ],
    ...
    signatures.insert("telldir", BuiltinSignature {
        signatures: vec![
            "telldir DIRHANDLE",
        ],
    ...
    signatures.insert("seekdir", BuiltinSignature {
        signatures: vec![
    ...
    // ===== File Operations =====
    signatures.insert("chmod", BuiltinSignature {
        signatures: vec![
            "chmod MODE, LIST",
        ],
    ...
    signatures.insert("chown", BuiltinSignature {
        signatures: vec![
            "chown UID, GID, LIST",
        ],
    ...
    signatures.insert("link", BuiltinSignature {
        signatures: vec![
    ...
    signatures.insert("symlink", BuiltinSignature {
        signatures: vec![
    ...
    signatures.insert("readlink", BuiltinSignature {
        signatures: vec![
            "readlink EXPR",
            "readlink",
        ],
    ...
    signatures.insert("rename", BuiltinSignature {
        signatures: vec![
    ...
    signatures.insert("unlink", BuiltinSignature {
        signatures: vec![
            "unlink LIST",
            "unlink",
        ],
    ...
    signatures.insert("mkdir", BuiltinSignature {
        signatures: vec![
            "mkdir FILENAME, MODE",
            "mkdir FILENAME",
        ],
    ...
    signatures.insert("rmdir", BuiltinSignature {
        signatures: vec![
            "rmdir FILENAME",
            "rmdir",
        ],
    ...
    signatures.insert("fork", BuiltinSignature {
        signatures: vec![
            "fork",
        ],
    ...
    signatures.insert("wait", BuiltinSignature {
        signatures: vec![
            "wait",
        ],
    ...
    signatures.insert("waitpid", BuiltinSignature {
        signatures: vec![
            "waitpid PID, FLAGS",
        ],
    ...
    signatures.insert("kill", BuiltinSignature {
        signatures: vec![
            "kill SIGNAL, LIST",
        ],
    ...
    signatures.insert("getpid", BuiltinSignature {
        signatures: vec![
            "getpid",
        ],
    ...
    signatures.insert("getppid", BuiltinSignature {
        signatures: vec![
            "getppid",
        ],
    ...
    // ===== Time Functions =====
    signatures.insert("time", BuiltinSignature {
        signatures: vec![
            "time",
        ],
    ...
    signatures.insert("localtime", BuiltinSignature {
        signatures: vec![
            "localtime EXPR",
            "localtime",
        ],
    ...
    signatures.insert("gmtime", BuiltinSignature {
        signatures: vec![
            "gmtime EXPR",
            "gmtime",
        ],
    ...
    signatures.insert("sleep", BuiltinSignature {
        signatures: vec![
            "sleep EXPR",
            "sleep",
        ],
    ...
    signatures.insert("alarm", BuiltinSignature {
        signatures: vec![
            "alarm SECONDS",
            "alarm",
        ],
    ...
    signatures.insert("abs", BuiltinSignature {
        signatures: vec![
            "abs VALUE",
            "abs",
        ],
    ...
    signatures.insert("atan2", BuiltinSignature {
        signatures: vec![
            "atan2 Y, X",
        ],
    ...
    signatures.insert("cos", BuiltinSignature {
        signatures: vec![
            "cos EXPR",
            "cos",
        ],
    ...
    signatures.insert("sin", BuiltinSignature {
        signatures: vec![
            "sin EXPR",
            "sin",
        ],
    ...
    signatures.insert("exp", BuiltinSignature {
        signatures: vec![
            "exp EXPR",
            "exp",
        ],
    ...
    signatures.insert("log", BuiltinSignature {
        signatures: vec![
            "log EXPR",
            "log",
        ],
    ...
    signatures.insert("sqrt", BuiltinSignature {
        signatures: vec![
            "sqrt EXPR",
            "sqrt",
        ],
    ...
    signatures.insert("int", BuiltinSignature {
        signatures: vec![
            "int EXPR",
            "int",
        ],
    ...
    signatures.insert("rand", BuiltinSignature {
        signatures: vec![
            "rand EXPR",
            "rand",
        ],
    ...
    signatures.insert("srand", BuiltinSignature {
        signatures: vec![
            "srand EXPR",
            "srand",
        ],
    ...
    signatures.insert("defined", BuiltinSignature {
        signatures: vec![
            "defined EXPR",
            "defined",
        ],
    ...
    signatures.insert("undef", BuiltinSignature {
        signatures: vec![
            "undef EXPR",
            "undef",
        ],
    ...
    signatures.insert("scalar", BuiltinSignature {
        signatures: vec![
            "scalar EXPR",
        ],
    ...
    signatures.insert("wantarray", BuiltinSignature {
        signatures: vec![
            "wantarray",
        ],
    ...
    // ===== Control Flow =====
    signatures.insert("die", BuiltinSignature {
        signatures: vec![
            "die LIST",
            "die",
        ],
    ...
    signatures.insert("warn", BuiltinSignature {
        signatures: vec![
            "warn LIST",
            "warn",
        ],
    ...
    signatures.insert("exit", BuiltinSignature {
        signatures: vec![
            "exit EXPR",
            "exit",
        ],
    ...
    signatures.insert("return", BuiltinSignature {
        signatures: vec![
            "return LIST",
            "return",
        ],
    ...
    signatures.insert("next", BuiltinSignature {
        signatures: vec![
            "next LABEL",
            "next",
        ],
    ...
    signatures.insert("last", BuiltinSignature {
        signatures: vec![
            "last LABEL",
            "last",
        ],
    ...
    signatures.insert("redo", BuiltinSignature {
        signatures: vec![
            "redo LABEL",
            "redo",
        ],
    ...
    signatures.insert("goto", BuiltinSignature {
        signatures: vec![
            "goto LABEL",
            "goto EXPR",
            "goto &NAME",
    ...
    // ===== Module Functions =====
    signatures.insert("require", BuiltinSignature {
        signatures: vec![
            "require VERSION",
            "require MODULE",
            "require EXPR",
    ...
    signatures.insert("use", BuiltinSignature {
        signatures: vec![
    ...
    signatures.insert("no", BuiltinSignature {
        signatures: vec![
    ...
    signatures.insert("import", BuiltinSignature {
        signatures: vec![
            "import MODULE LIST",
        ],
    ...
    signatures.insert("unimport", BuiltinSignature {
        signatures: vec![
    ...
    // ===== Package Functions =====
    signatures.insert("package", BuiltinSignature {
        signatures: vec![
    ...
    signatures.insert("caller", BuiltinSignature {
        signatures: vec![
            "caller EXPR",
            "caller",
        ],
    ...
    // ===== Eval and Do =====
    signatures.insert("eval", BuiltinSignature {
        signatures: vec![
            "eval EXPR",
            "eval BLOCK",
        ],
    ...
    signatures.insert("do", BuiltinSignature {
        signatures: vec![
            "do FILENAME",
            "do BLOCK",
        ],
    ...
    // ===== Tied Variables =====
    signatures.insert("tie", BuiltinSignature {
        signatures: vec![
    ...
    signatures.insert("tied", BuiltinSignature {
        signatures: vec![
            "tied VARIABLE",
        ],
    ...
    signatures.insert("untie", BuiltinSignature {
        signatures: vec![
            "untie VARIABLE",
        ],
    ...
    // ===== Socket Functions =====
    signatures.insert("socket", BuiltinSignature {
        signatures: vec![
    ...
    signatures.insert("bind", BuiltinSignature {
        signatures: vec![
            "bind SOCKET, NAME",
        ],
    ...
    signatures.insert("listen", BuiltinSignature {
        signatures: vec![
    ...
    signatures.insert("accept", BuiltinSignature {
        signatures: vec![
    ...
    signatures.insert("connect", BuiltinSignature {
        signatures: vec![
            "connect SOCKET, NAME",
        ],
    ...
    signatures.insert("shutdown", BuiltinSignature {
        signatures: vec![
            "shutdown SOCKET, HOW",
        ],
    ...
    signatures.insert("send", BuiltinSignature {
        signatures: vec![
    ...
    signatures.insert("recv", BuiltinSignature {
        signatures: vec![
    ...
    // ===== Pack/Unpack =====
    signatures.insert("pack", BuiltinSignature {
        signatures: vec![
            "pack TEMPLATE, LIST",
        ],
    ...
    signatures.insert("unpack", BuiltinSignature {
        signatures: vec![
    ...
    // ===== Regular Expression =====
    signatures.insert("study", BuiltinSignature {
        signatures: vec![
            "study SCALAR",
            "study",
        ],
    ...
    signatures.insert("pos", BuiltinSignature {
        signatures: vec![
            "pos SCALAR",
            "pos",
        ],
    ...
    signatures.insert("reset", BuiltinSignature {
        signatures: vec![
            "reset EXPR",
            "reset",
        ],
    ...
    // ===== Format Functions =====
    signatures.insert("formline", BuiltinSignature {
        signatures: vec![
    ...
    signatures.insert("format", BuiltinSignature {
        signatures: vec![
            "format NAME =",
        ],
    ...
    // ===== Miscellaneous =====
    signatures.insert("dump", BuiltinSignature {
        signatures: vec![
            "dump LABEL",
            "dump",
        ],
    ...
    signatures.insert("vec", BuiltinSignature {
        signatures: vec![
    ...
    signatures.insert("prototype", BuiltinSignature {
        signatures: vec![
            "prototype FUNCTION",
        ],
    ...
    signatures.insert("lock", BuiltinSignature {
        signatures: vec![
            "lock THING",
        ],
