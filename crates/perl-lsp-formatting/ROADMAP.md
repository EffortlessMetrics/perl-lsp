# perl-lsp-formatting Roadmap

> **Note:** This is the component-specific roadmap for `perl-lsp-formatting`. For the project-wide roadmap, see [`docs/project/ROADMAP.md`](../../docs/project/ROADMAP.md).
