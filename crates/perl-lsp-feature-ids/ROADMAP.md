# perl-lsp-feature-ids Roadmap

> **Note:** This is the component-specific roadmap for `perl-lsp-feature-ids`. For the project-wide roadmap, see [`docs/project/ROADMAP.md`](../../docs/project/ROADMAP.md).
