# perl-lsp-code-actions Roadmap

> **Note:** This is the component-specific roadmap for `perl-lsp-code-actions`. For the project-wide roadmap, see [`docs/project/ROADMAP.md`](../../docs/project/ROADMAP.md).
