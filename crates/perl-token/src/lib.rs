...
impl TokenKind {
    ...
    /// Canonical Perl spellings for keyword token kinds.
    pub fn keyword_spellings() -> &'static [(TokenKind, &'static str)] {
        KEYWORD_SPELLINGS
    }

    /// Canonical Perl spellings for operator token kinds.
    pub fn operator_spellings() -> &'static [(TokenKind, &'static str)] {
        OPERATOR_SPELLINGS
    }

    /// Canonical Perl spellings for delimiter token kinds.
    pub fn delimiter_spellings() -> &'static [(TokenKind, &'static str)] {
        DELIMITER_SPELLINGS
    }

    /// Canonical Perl spellings for sigil token kinds.
    pub fn sigil_spellings() -> &'static [(TokenKind, &'static str)] {
        SIGIL_SPELLINGS
    }

    /// Every token kind variant, listed exactly once.
    pub fn all_kinds() -> &'static [TokenKind] {
        ALL_TOKEN_KINDS
    }
}
...
const OPERATOR_SPELLINGS: &[(TokenKind, &str)] = &[
    (TokenKind::Assign, "="),
    (TokenKind::Plus, "+"),
    (TokenKind::Minus, "-"),
    (TokenKind::Star, "*"),
...
const DELIMITER_SPELLINGS: &[(TokenKind, &str)] = &[
    (TokenKind::LeftParen, "("),
    (TokenKind::RightParen, ")"),
    (TokenKind::LeftBrace, "{"),
    (TokenKind::RightBrace, "}"),
...
const SIGIL_SPELLINGS: &[(TokenKind, &str)] = &[
    (TokenKind::ScalarSigil, "$"),
    (TokenKind::ArraySigil, "@"),
    (TokenKind::HashSigil, "%"),
    (TokenKind::SubSigil, "&"),
