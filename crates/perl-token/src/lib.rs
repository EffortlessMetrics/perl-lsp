...
impl TokenKind {
    ...
    /// Canonical keyword spellings and their token kinds.
    pub const KEYWORD_SPELLINGS: &'static [(TokenKind, &'static str)] = &[
        (TokenKind::My, "my"),
        (TokenKind::Our, "our"),
        (TokenKind::Local, "local"),
        (TokenKind::State, "state"),
    ...
    /// Canonical operator spellings and their token kinds.
    pub const OPERATOR_SPELLINGS: &'static [(TokenKind, &'static str)] = &[
        (TokenKind::Assign, "="),
        (TokenKind::Plus, "+"),
        (TokenKind::Minus, "-"),
        (TokenKind::Star, "*"),
    ...
    /// Canonical delimiter spellings and their token kinds.
    pub const DELIMITER_SPELLINGS: &'static [(TokenKind, &'static str)] = &[
        (TokenKind::LeftParen, "("),
        (TokenKind::RightParen, ")"),
        (TokenKind::LeftBrace, "{"),
        (TokenKind::RightBrace, "}"),
    ...
    /// Canonical sigil spellings and their token kinds.
    pub const SIGIL_SPELLINGS: &'static [(TokenKind, &'static str)] = &[
        (TokenKind::ScalarSigil, "$"),
        (TokenKind::ArraySigil, "@"),
        (TokenKind::HashSigil, "%"),
        (TokenKind::SubSigil, "&"),
