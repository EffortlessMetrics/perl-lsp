...
/// High-level token category for status/coverage reporting.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
#[non_exhaustive]
...
impl TokenKind {
    /// Canonical list of all token variants.
    pub const ALL: [TokenKind; 132] = [
        // Keywords
        TokenKind::My,
        TokenKind::Our,
        TokenKind::Local,
    ...
    /// Category assignment for this token kind.
