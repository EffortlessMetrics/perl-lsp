...
impl TokenKind {
    ...
    /// Return keywords with canonical source spelling.
    ...
    /// Return operators with canonical source spelling.
    ...
    /// Return delimiters with canonical source spelling.
    pub fn delimiter_spellings() -> &'static [(TokenKind, &'static str)] {
        const DELIMITERS: &[(TokenKind, &str)] = &[
            (TokenKind::LeftParen, "("),
            (TokenKind::RightParen, ")"),
            (TokenKind::LeftBrace, "{"),
            (TokenKind::RightBrace, "}"),
    ...
    /// Return sigils with canonical source spelling.
    pub fn sigil_spellings() -> &'static [(TokenKind, &'static str)] {
        const SIGILS: &[(TokenKind, &str)] = &[
            (TokenKind::ScalarSigil, "$"),
            (TokenKind::ArraySigil, "@"),
            (TokenKind::HashSigil, "%"),
            (TokenKind::SubSigil, "&"),
