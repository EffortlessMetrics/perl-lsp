# perl-lsp-feature-governance Roadmap

> **Note:** This is the component-specific roadmap for `perl-lsp-feature-governance`. For the project-wide roadmap, see [`docs/project/ROADMAP.md`](../../docs/project/ROADMAP.md).
