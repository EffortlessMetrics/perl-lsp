...
fn test_orphaned_else_does_not_crash() {
    ...
    assert!(
        sexp.contains("if"),
        "orphaned else should produce an if node, got: {}",
        sexp,
    );
}
...
fn test_orphaned_elsif_does_not_crash() {
    ...
    assert!(
        sexp.contains("if"),
        "orphaned elsif should produce an if node, got: {}",
        sexp,
    );
}
...
fn test_orphaned_elsif_with_else_chain() {
    ...
    assert!(
        sexp.contains("if"),
        "orphaned elsif chain should produce an if node, got: {}",
        sexp,
    );
}
...
fn test_orphaned_else_followed_by_valid_code() {
    ...
    assert!(
        sexp.contains("if"),
        "should contain recovered if node, got: {}",
        sexp,
    );
}
