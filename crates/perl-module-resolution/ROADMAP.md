# perl-module-resolution Roadmap

> **Note:** This is the component-specific roadmap for `perl-module-resolution`. For the project-wide roadmap, see [`docs/project/ROADMAP.md`](../../docs/project/ROADMAP.md).
