...
mod mock_streaming_completion_tests {
    ...
    impl perl_lsp_rs_core::providers::inline_completion::InlineCompletionBackend for MockErrorChunkBackend {
        fn stream(
            &self,
            _req: &perl_lsp_rs_core::providers::inline_completion::BackendRequest,
            sink: &mut dyn FnMut(
            ...
            Err(perl_lsp_rs_core::providers::inline_completion::BackendError::Provider("mock stream error".into()))
        }
    }
