...
//!
//! This module now delegates to the `perl-lsp-feature-governance` microcrate, which
//! owns the canonical BDD-grid and profile governance API while keeping the existing
