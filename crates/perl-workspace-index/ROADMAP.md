# perl-workspace-index Roadmap

> **Note:** This is the component-specific roadmap for `perl-workspace-index`. For the project-wide roadmap, see [`docs/project/ROADMAP.md`](../../docs/project/ROADMAP.md).
