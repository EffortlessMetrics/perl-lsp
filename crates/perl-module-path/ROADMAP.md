# perl-module-path Roadmap

> **Note:** This is the component-specific roadmap for `perl-module-path`. For the project-wide roadmap, see [`docs/project/ROADMAP.md`](../../docs/project/ROADMAP.md).
