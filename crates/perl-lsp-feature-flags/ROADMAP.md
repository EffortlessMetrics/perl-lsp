# perl-lsp-feature-flags Roadmap

> **Note:** This is the component-specific roadmap for `perl-lsp-feature-flags`. For the project-wide roadmap, see [`docs/project/ROADMAP.md`](../../docs/project/ROADMAP.md).
