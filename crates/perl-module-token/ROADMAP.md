# perl-module-token Roadmap

> **Note:** This is the component-specific roadmap for `perl-module-token`. For the project-wide roadmap, see [`docs/project/ROADMAP.md`](../../docs/project/ROADMAP.md).
