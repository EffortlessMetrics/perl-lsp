# perl-lsp-navigation Roadmap

> **Note:** This is the component-specific roadmap for `perl-lsp-navigation`. For the project-wide roadmap, see [`docs/project/ROADMAP.md`](../../docs/project/ROADMAP.md).
