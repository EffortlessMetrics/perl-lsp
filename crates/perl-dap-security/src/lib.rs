//! Security validation helpers for the Perl DAP ecosystem.
//!
//! This crate provides a focused safety boundary for:
//! - Path traversal prevention
//! - Expression/condition input validation
...
/// Validate and clamp a timeout value into accepted bounds.
