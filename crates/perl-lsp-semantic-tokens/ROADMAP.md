# perl-lsp-semantic-tokens Roadmap

> **Note:** This is the component-specific roadmap for `perl-lsp-semantic-tokens`. For the project-wide roadmap, see [`docs/project/ROADMAP.md`](../../docs/project/ROADMAP.md).
