# perl-tokenizer Roadmap

> **Note:** This is the component-specific roadmap for `perl-tokenizer`. For the project-wide roadmap, see [`docs/project/ROADMAP.md`](../../docs/project/ROADMAP.md).
