...
> **Note:** This is the component-specific roadmap for `perl-lsp-feature-profile`. For the project-wide roadmap, see [`docs/project/ROADMAP.md`](../../docs/project/ROADMAP.md).
