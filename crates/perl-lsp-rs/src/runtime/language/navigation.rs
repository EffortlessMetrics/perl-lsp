...
use perl_lsp_rs_core::providers::inheritance::package_resolution_order;
...
fn inherited_method_definition_location(
    ...
    for package_name in package_resolution_order(workspace_index, receiver_pkg).into_iter().skip(1)
    {
