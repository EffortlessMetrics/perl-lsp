...
//!
//! ```no_run
//! use perl_dap_configuration::LaunchConfiguration;
...
//!
//! ```
//! use perl_dap_configuration::AttachConfiguration;
//!
//! # fn main() -> Result<(), Box<dyn std::error::Error>> {
...
///
/// ```
/// use perl_dap_configuration::create_launch_json_snippet;
///
...
///
/// ```
/// use perl_dap_configuration::create_attach_json_snippet;
///
