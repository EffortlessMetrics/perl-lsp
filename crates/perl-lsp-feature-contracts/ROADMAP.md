# perl-lsp-feature-contracts Roadmap

> **Note:** This is the component-specific roadmap for `perl-lsp-feature-contracts`. For the project-wide roadmap, see [`docs/project/ROADMAP.md`](../../docs/project/ROADMAP.md).
