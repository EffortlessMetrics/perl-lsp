...
mod tests {
    ...
    fn is_expandable_all_variants() {
        ...
        assert!(!PerlValue::Number(3.14).is_expandable());
        ...
        assert!(!PerlValue::Truncated { summary: "...".into(), total_count: Some(100) }.is_expandable());
        ...
        assert!(PerlValue::Hash(vec![]).is_expandable());
        assert!(PerlValue::Reference(Box::new(PerlValue::Undef)).is_expandable());
        assert!(PerlValue::Object { class: "Foo".into(), value: Box::new(PerlValue::Hash(vec![])) }.is_expandable());
    ...
    fn type_name_all_variants() {
        ...
        assert_eq!(PerlValue::Object { class: "Foo".into(), value: Box::new(PerlValue::Undef) }.type_name(), "OBJECT");
    ...
    fn child_count_all_variants() {
        ...
        assert_eq!(PerlValue::Array(vec![PerlValue::Integer(1), PerlValue::Integer(2), PerlValue::Integer(3)]).child_count(), Some(3));
        assert_eq!(PerlValue::Array(vec![]).child_count(), Some(0));
        assert_eq!(PerlValue::Hash(vec![("a".into(), PerlValue::Undef), ("b".into(), PerlValue::Undef)]).child_count(), Some(2));
        ...
        assert_eq!(PerlValue::Truncated { summary: "big".into(), total_count: Some(500) }.child_count(), Some(500));
        assert_eq!(PerlValue::Truncated { summary: "big".into(), total_count: None }.child_count(), None);
    }
    ...
    fn nested_value_structure() {
        let nested = PerlValue::object(
            ...
            PerlValue::hash(vec![
                ...
                ("scores".into(), PerlValue::array(vec![
