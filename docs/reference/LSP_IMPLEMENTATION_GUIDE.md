...
| `perl.explainProviderDecision` | ✅ Conservative v1 | Native | <50ms | Structured confidence/freshness explanation with current provider receipt anchors; unknown provider means low-confidence fallback |
