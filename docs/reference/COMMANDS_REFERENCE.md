...
- ✅ `perl.safeDelete` - Return a narrow source-backed safe-delete WorkspaceEdit only when the fresh compiler plan is allowed and rollback proof is exact. Broader symbol deletion remains gated.
