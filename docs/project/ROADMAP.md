...
- Issue #3539 coroutine scope corrected: defer undocumented core `coro`/`yield` syntax; split follow-up toward CPAN `Coro` LSP UX support ([ISSUE_3539_RESCOPE.md](ISSUE_3539_RESCOPE.md))
