...
| `real_workspace_baseline_count` | `1` small CPAN-style baseline family, `4` Perl files, `2` baseline tests | Real-workspace proof has started, but it is not yet broad ecosystem coverage. | [semantic_real_workspace_baseline.rs](../../../crates/perl-workspace-index/tests/semantic_real_workspace_baseline.rs) |
