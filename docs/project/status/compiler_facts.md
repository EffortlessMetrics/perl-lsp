...
| CompileEnvironment facts | `fixture-backed` | [#8206](https://github.com/EffortlessMetrics/perl-lsp/issues/8206) | `crates/perl-parser-core/tests/hir_tests.rs` | Add module-resolution candidate facts in [#8242](https://github.com/EffortlessMetrics/perl-lsp/issues/8242) |
| Module-resolution candidates | `planned` | [#8242](https://github.com/EffortlessMetrics/perl-lsp/issues/8242) | Shared include-root builder in `perl-module` | Candidate facts keyed to HIR module requests |
| ImportSpec / ExportSet / visible symbols | `semantic-shadowed` | [#8244](https://github.com/EffortlessMetrics/perl-lsp/issues/8244) | [Semantic scorecard](semantic_scorecard.md) and [semantic shadow compare](semantic_shadow_compare.md) | Move toward canonical compiler facts without provider cutover |
