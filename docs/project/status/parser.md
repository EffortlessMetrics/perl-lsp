...
| **Ubuntu system Perl** | 97.1% clean (`6890/7095`) | Compatibility baseline; Perl `5.038002`, `48` unreadable, `157` with errors, clean `6890`, parser-gap `79`, recovery-only `0`, known-invalid `0`, unreadable `48`, baseline `2026-04-09` | `.ci/parser-corpus-baseline.json` |
| **CPAN top 1000** | 95.3% clean (`8931/9372`) | Ecosystem breadth baseline; `6` unreadable, `435` with errors, clean `8931`, parser-gap `219`, recovery-only `0`, known-invalid `0`, unreadable `6`, cached downloads in `target/cpan-corpus/.cpanm`, baseline `2026-04-09` | `.ci/cpan-corpus-baseline.json` |
