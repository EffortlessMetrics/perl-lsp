...
| **Ubuntu system Perl** | 94.5% clean (`2825/2990`) | Compatibility baseline; Perl `5.038002`, `42` unreadable, `123` with errors, 123 valid gaps / 0 recovery-only / 0 known-invalid / 42 unreadable, baseline `2026-04-24` | `.ci/parser-corpus-baseline.json` |
| **CPAN top 1000** | 95.3% clean (`8931/9372`) | Ecosystem breadth baseline; `6` unreadable, `435` with errors, 219 valid gaps / 0 recovery-only / 0 known-invalid / 6 unreadable, cached downloads in `target/cpan-corpus/.cpanm`, baseline `2026-04-09` | `.ci/cpan-corpus-baseline.json` |
