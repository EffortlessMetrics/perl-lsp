...
| **Accuracy denominator** | 46 fixtures / 28 families | 126 scored lines, 102 scored symbols, 2 fully labeled, 43 partial, 31 unknown, 5 negative, 13 dynamic boundaries, 5 unsupported, 0 real-project, 0 generated, 46 hand-labeled; cadence `pr` | `target/metrics/parser_accuracy.json`; `.kiro/specs/parser-accuracy-observability` |
