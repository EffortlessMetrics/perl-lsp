...
| **Accuracy denominator** | 46 fixtures / 28 families | 129 scored lines, 103 scored symbols, 3 fully labeled, 42 partial, 30 unknown, 5 negative, 13 dynamic boundaries, 8 unsupported, 0 real-project, 0 generated, 46 hand-labeled; cadence `pr` | `target/metrics/parser_accuracy.json`; `.kiro/specs/parser-accuracy-observability` |
