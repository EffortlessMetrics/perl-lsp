...
| **Ubuntu system Perl** | 97.1% clean (`6890/7095`) | Compatibility baseline; Perl `5.038002`, `79` valid gaps, `0` recovery-only, `0` known-invalid, `48` unreadable, baseline `2026-04-09` | `.ci/parser-corpus-baseline.json` |
| **CPAN top 1000** | 95.3% clean (`8931/9372`) | Ecosystem breadth baseline; `216` valid gaps, `2` recovery-only, `1` known-invalid, `6` unreadable, cached downloads in `target/cpan-corpus/.cpanm`, baseline `2026-04-09` | `.ci/cpan-corpus-baseline.json` |
