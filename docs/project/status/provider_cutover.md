...
- Rename and safe-delete now have boundary-shadowed proof for exact static
  ...
  receipt-only evidence without enabling live package rename, the runtime
  ...
  the no-edit UX, rollback/fallback, and generated/dynamic/stale/low-confidence
  guardrails for source-backed definition/reference plans without authorizing
  package rename.
