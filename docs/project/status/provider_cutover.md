...
- Safe-delete support review, 2026-05-18: the referenced-source and Catalyst
  ...
  dynamic, stale, low-confidence, ambiguous, or workspace-referenced symbols.
  The next promotion decision requires the remaining non-subroutine,
  package-wide, generated/no-source, and dynamic blocker proof.
