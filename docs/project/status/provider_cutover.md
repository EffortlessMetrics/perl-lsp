...
- Mojolicious scenario 36 adds a real-workspace safe-delete warning receipt for
  ...
  allow proof, exact source guard, workspace identity guard, and rollback proof
  all pass.
