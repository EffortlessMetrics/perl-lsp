...
- Safe-delete support review, 2026-05-18: the referenced-source and Catalyst
  false-allow receipts keep safe-delete `partial live source-backed` only. They
  do not promote package-wide, non-subroutine, generated/no-source, imported,
  dynamic, stale, low-confidence, ambiguous, or cross-project referenced
  symbols. The next promotion decision requires cross-project referenced-source
  blocker receipts plus the remaining non-subroutine, package-wide,
  generated/no-source, and dynamic blocker proof.
...
- Semantic-token note, 2026-05-18: method-declaration, package-declaration,
  field-declaration, and method-call parity have moved to scoped
