...
- Rename and safe-delete now have boundary-shadowed proof for exact static
  ...
  and the compiler-allowed preview receipt proves the no-edit UX shape for
  source-backed definition/reference plans without authorizing package rename.
