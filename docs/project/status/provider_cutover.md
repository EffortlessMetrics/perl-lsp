...
- Safe-delete support review, 2026-05-18: the referenced-source, Catalyst
  false-allow, and non-subroutine/package-wide source-guard receipts keep
  safe-delete `partial live source-backed` only. They do not promote broader
  symbol deletion, generated/no-source, imported, dynamic, stale,
  low-confidence, ambiguous, or workspace-referenced symbols. The next
  promotion decision requires the remaining generated/no-source and dynamic
  blocker proof.
