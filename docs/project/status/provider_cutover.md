...
- Semantic tokens now have runtime integration quality receipts
  ...
  invariant, no-token-output-change invariant, and token-count parity with the
  live handler. Broader compiler-fact token classes remain pending staged
  cutover.
