...
| Workspace symbols | Source-backed generated/framework symbol | `generated-label pilot` | Support review after scoped Moo predicate proof | Fresh source-backed generated/framework member has an explicit generated label and a framework declaration anchor with bounded confidence | Keep generated candidate receipt-only when source anchor or label is missing | Virtual/no-source generated member, exact generated method-body claim, stale fact, dynamic boundary, low confidence, ambiguity, partial index, or fallback/noise candidate |
