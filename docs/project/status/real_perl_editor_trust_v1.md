...
1. `test(safe-delete): add second project-shaped source-backed live-pilot receipt`
...
a second project-shaped source-backed live-pilot receipt that preserves the same
compiler allow proof, exact source guard, rollback proof, and blocker/fallback
boundaries before any broader safe-delete promotion.
