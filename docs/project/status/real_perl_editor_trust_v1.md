...
1. `test(semantic-tokens): add class-specific compiler-token expansion receipt`
2. `test(workspace-symbols): add generated-symbol expansion rank/noise receipt`
3. `docs(status): review package-local rename support before broader promotion`
