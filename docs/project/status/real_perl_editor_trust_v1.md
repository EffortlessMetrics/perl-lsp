...
1. `feat(provider): add provider decision explanation model`
2. `feat(ux): expose explain-provider-decision command`
3. `docs(user): explain measured Perl editor trust`
