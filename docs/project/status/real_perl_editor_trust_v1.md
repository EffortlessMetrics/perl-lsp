...
1. `test(semantic-tokens): prove scoped class cutover before broader compiler-token promotion`
2. `test(workspace-symbols): prove scoped generated-symbol cutover before broader generated-symbol expansion`
3. `test(rename): add project-shaped package/compiler-backed false-allow and fallback receipt`
