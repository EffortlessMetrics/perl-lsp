...
2. `feat(provider): attach request-local provider decision receipts`
3. `test(rename): add additional request-local package/compiler-backed fallback/noise receipts`
