...
role composition, and method modifiers. Any broader generated-symbol expansion
still needs scoped cutover proof. This review does not promote workspace
...
1. `test(workspace-symbols): prove scoped generated-symbol cutover before broader generated-symbol expansion`
2. `test(rename): add project-shaped package/compiler-backed false-allow and fallback receipt`
3. `test(semantic-tokens): prove another scoped compiler-token class before broader compiler-token promotion`
