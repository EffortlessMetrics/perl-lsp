...
promote safe-delete beyond the exact source-backed subroutine pilot.
...
The non-subroutine/package-wide safe-delete source-guard receipt closes the
immediate safe-delete source-guard routing item without broadening deletion.

1. `test(safe-delete): add generated/no-source and dynamic blocker receipts`
