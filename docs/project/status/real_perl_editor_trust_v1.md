...
1. `test(rename): add package/compiler-backed fallback/noise receipt`
2. `docs(status): review refactor support tiers before any symbol-level safe-delete cutover`
