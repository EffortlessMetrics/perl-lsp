...
| Document symbols | `partial live source-backed` | Runtime quality receipts plus Mojolicious scenario 32 record selected source-backed parser-syntax package/subroutine symbols and fact traces | Astless, stale, dynamic, virtual generated/no-source, low-confidence, ambiguous, accessor, and broader project-shaped candidates keep fallback/gated behavior | Additional real-workspace receipts for generated labels, accessors, missing symbols, and dynamic/stale blockers before broader symbol cutover |
