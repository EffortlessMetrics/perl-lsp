...
guard. Broader package/compiler-backed rename now needs support review after
the additional Dancer2 fallback/edit-freshness receipt before any promotion. Safe
...
1. `docs(status): review package-local rename support after Dancer2 fallback/edit-freshness receipt`
