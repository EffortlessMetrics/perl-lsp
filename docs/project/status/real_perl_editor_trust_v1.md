...
The package-declaration live-trace expansion moves the next semantic-token step
into the remaining scoped field/method-call trace classes.
...
3. `test(workspace-symbols): add additional generated/no-source project variant only if broader generated-symbol expansion is being considered`
