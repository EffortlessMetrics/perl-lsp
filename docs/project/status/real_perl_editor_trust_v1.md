...
The package-declaration plus field/method-call live-trace expansions close the
...
2. `feat(diagnostics): add explain diagnostic payload`
3. `test(rename): keep package/compiler-backed fallback and edit-freshness receipts current before broader promotion`
