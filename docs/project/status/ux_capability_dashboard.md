...
| Hover | `semantic-shadow` | [semantic_shadow_compare.md](semantic_shadow_compare.md) records four schema-fixture `Hover` provenance receipts: imported-symbol, framework-generated, dynamic-boundary, and fallback paths. | Hover provenance is now fixture-backed with typed source / provenance / confidence / freshness traces and source labels, without claiming a broad runtime cutover. | Real-workspace hover quality and runtime integration are not yet separately proven. | Add real-workspace hover receipts before broader live cutover |
...
| Workspace symbols | `semantic-shadow` | [semantic_shadow_compare.md](semantic_shadow_compare.md) records four schema-fixture `WorkspaceSymbols` source/freshness receipts: imported compiler fact, framework-generated candidate, dynamic-boundary blocker, and stale compiler fact blocker. | Workspace-symbol provider cutover now has typed source / provenance / confidence / freshness traces without claiming live provider behavior. | Existing workspace index remains the live provider source. Runtime integration and real-workspace quality are not yet separately proven. | Add runtime integration and real-workspace workspace-symbol quality receipts before live cutover |
