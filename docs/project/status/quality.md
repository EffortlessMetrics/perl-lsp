...
- **UX signal tracking**: fixture matrix tracks 17 workflows (16 PR-tier, 1 nightly-tier); top-line metric coverage = workflow_pass_rate (17), workflow_stability_rate (17), p95_time_to_first_useful_result_ms (1)
