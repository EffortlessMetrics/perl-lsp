...
### Manual Installation
Download the `.vsix` file from [releases](https://github.com/EffortlessSteven/tree-sitter-perl/releases) and install:
```bash
...
3. Try manual download: [releases](https://github.com/EffortlessSteven/tree-sitter-perl/releases)
...
- **Discussions**: [GitHub Discussions](https://github.com/EffortlessSteven/tree-sitter-perl/discussions)
