...
| **LSP Coverage** | 88% (29/33 GA advertised, `features.toml`) | 93%+ | In progress |
...
- **LSP Coverage**: 88% cataloged GA coverage (29/33 trackable features from `features.toml`)
...
**Target**: 93%+ LSP coverage (from current 88%)
