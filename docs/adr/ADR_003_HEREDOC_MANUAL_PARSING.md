# ADR-003: Manual Character-by-Character Parsing for Heredoc Declarations
...
**Related Issues**: [Issue #183 - Handle backreferences in heredoc parsing](https://github.com/EffortlessSteven/tree-sitter-perl/issues/183)
