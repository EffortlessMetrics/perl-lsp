...
| Codex app | use `perllsp --check` / `--check-project` through the integrated terminal or project actions | [docs/EDITORS/CODEX_APP_SETUP.md](../EDITORS/CODEX_APP_SETUP.md) |
| Codex IDE Extension | use Codex in a VS Code-compatible editor with `EffortlessMetrics.perl-lsp-rs` for live LSP features | [docs/EDITORS/VS_CODE_SETUP.md](../EDITORS/VS_CODE_SETUP.md) |
...
and diagnostics, use a real editor LSP client.
