...
LSP features such as editor squiggles, hover, go-to-definition, or references.
...
Extension and the `EffortlessMetrics.perl-lsp-rs` Perl LSP extension in a
VS Code-compatible editor. See [VS Code setup](VS_CODE_SETUP.md).
...
Codex can run commands in the project through its integrated terminal or through
project actions.
...
Use this as a quick validation button for Perl parse diagnostics.
...
3. Install the Perl LSP extension: `EffortlessMetrics.perl-lsp-rs`.
...
See `docs/EDITORS/VS_CODE_SETUP.md` for the full editor setup.
...
### Codex app does not show squiggles, hover, or references
