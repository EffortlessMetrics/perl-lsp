...
#!/usr/bin/perl
#Test file: Edge cases andunusual valid Perl constructs
...
map{$_*2}1..10;    # No spaceafter map
&{{sub{sub{42}}}};  # Nestedanonymous subs
