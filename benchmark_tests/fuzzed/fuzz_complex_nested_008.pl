...
#!/usr/bin/perl
sub foo { }
# Test file: Deeply  nestedstructures to stressparser recursion
...
# Deeplynestedcontrol structures



subdeeply_nested_logic {
      my    ($x)  =@_;
...
# Deeply nested anonymoussubroutines
...
# Complex nestedternary operators
...
# Nested loops    withcomplex  conditions
