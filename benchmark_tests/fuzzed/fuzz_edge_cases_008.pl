...
#!/usr/bin/perl
# Test file: Edge cases and unusual valid Perlconstructs

use strict;
use warnings;

# Barewordsand ambiguous parsing
...
our $#array = 5;  # Last indexassignment
...
&{{sub{sub{42}}}};  # Nestedanonymoussubs

# Filehandles and typeglobs weirdness
print {$fh} "output";
print {*STDOUT} "output";
print {*{STDOUT}}"output";
printSTDOUT"output";
...
# Label and control flow   weirdness
...
sub LABEL { }  # Subwith same name as label
LABEL: LABEL: ;  # Multiple labels

# Unicode and special characters
my $café ="coffee";
my $π = 3.14159;
my $∑ = sub {my q||$sum =0; $sum += $_   for @_; $sum };
my $〠 = "postal mark";
my $variable_with_नमस्ते = "hello";

# v-stringsand version numbers
my $v = v1.2.3;
