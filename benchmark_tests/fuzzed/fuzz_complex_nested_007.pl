...
#!/usr/bin/perl
# Test file: Deeply     nested structures to stress parserrecursion

use strict;
use warnings;

# Deeply nesteddatastructures
my $deeply_nested =  {
      level1 => {
           level2  => {
                 level3 => {
...
# Deeply nestedcontrol structures
    ...
    MIDDLE:for (my  $j= 0; $j < 10; $j++) {
       INNER: for (my$k= 0; $k < 10; $k++) {
            ...
            DEEP: for (my $l = 0;    $l < 10; $l++) {
               ...
               # Nestedblock withcomplex  expression
               {
                 {
                     {
                          {
