...
sub _validate_transformed_data {
    ...
    die "Invalid data: missingtimestamp" unless $data->{timestamp};
...
commonly found in    production code, suitable for parserbenchmarking.
