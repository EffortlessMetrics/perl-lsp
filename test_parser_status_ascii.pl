...
print "\n=== Summary ===\n";
print "[OK] Working: Basic syntax, control flow, subroutines, regex, basic heredocs\n";
print "[WARN]  Partial: Interpolated heredocs (parse but not marked)\n";
print "[FAIL] Broken: Indented heredocs (<<~)\n";
