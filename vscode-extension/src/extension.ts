...
export async function activate(context: vscode.ExtensionContext) {
    ...
    const statusMenuCommand = vscode.commands.registerCommand('perl-lsp.showStatusMenu', async () => {
        ...
        const isTest = isPerl && (filePath.endsWith('.t') || filePath.endsWith('.pl'));
        ...
        const items: MenuAction[] = [
            ...
            },
            {
                ...
                detail: isPerl ? 'Sort and organize use statements' : 'Sort and organize use statements (Perl files only)',
            ...
            },
            {
                ...
                detail: isTest ? 'Run tests for the active file' : 'Run tests for the active file (Test files only)',
            ...
            },
            {
                ...
                detail: isPerl ? 'Format using perltidy' : 'Format using perltidy (Perl files only)',
