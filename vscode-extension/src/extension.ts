    ...
    const statusMenuCommand = vscode.commands.registerCommand('perl-lsp.showStatusMenu', async () => {
        ...
        const items: MenuAction[] = [
            ...
            },
            {
                ...
                detail: isPerl ? 'Sort and organize use statements' : 'Active file is not Perl',
            ...
            },
            {
                ...
                detail: isTestFile ? 'Run tests for the active file' : (isPerl ? 'Only for .t or .pl files' : 'Active file is not Perl'),
            ...
            },
            {
                ...
                detail: isPerl ? 'Format using perltidy' : 'Active file is not Perl',
