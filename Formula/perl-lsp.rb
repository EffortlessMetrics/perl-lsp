class PerlLsp < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/EffortlessSteven/tree-sitter-perl/releases/download/v#{version}/perl-lsp-aarch64-apple-darwin.tar.gz"
    sha256 "PLACEHOLDER_SHA256_AARCH64_DARWIN"
  elsif OS.mac?
    url "https://github.com/EffortlessSteven/tree-sitter-perl/releases/download/v#{version}/perl-lsp-x86_64-apple-darwin.tar.gz"
    sha256 "PLACEHOLDER_SHA256_X86_64_DARWIN"
  elsif OS.linux?
    url "https://github.com/EffortlessSteven/tree-sitter-perl/releases/download/v#{version}/perl-lsp-x86_64-unknown-linux-gnu.tar.gz"
