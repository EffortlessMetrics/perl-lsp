...
| End-to-end UX confidence | *qualitative* | Tracked via manual editor smoke workflows, the `perl-lsp-ux-tests` first-5-minutes harness, and open-issue burn-down; this is intentionally a qualitative signal today, not a published scalar | Anything about parser breadth, protocol catalog size, or capability count |
