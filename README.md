...
**New contributor?** Start with [docs/contributing/FIRST_PR.md](docs/contributing/FIRST_PR.md) â€” clone to PR in five minutes.
...
- Parser error recovery: unclosed block recovery ([PR #4079](https://github.com/EffortlessMetrics/perl-lsp/pull/4079)) and symbol extraction into partial `Error` nodes ([PR #4071](https://github.com/EffortlessMetrics/perl-lsp/pull/4071)); [#3499](https://github.com/EffortlessMetrics/perl-lsp/issues/3499) closed
...
- Pragma tracker improvements (`use if`, feature bundles, eval/sub-scoped pragma leakage, and conservative `eval STRING` handling); [#3489](https://github.com/EffortlessMetrics/perl-lsp/issues/3489) closed
