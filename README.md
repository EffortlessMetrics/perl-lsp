...
**Firebase Studio / OpenVSX environments** — install the same extension from Open VSX and follow [docs/EDITORS/FIREBASE_STUDIO_SETUP.md](docs/EDITORS/FIREBASE_STUDIO_SETUP.md).
