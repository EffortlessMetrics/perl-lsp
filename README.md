...
See [CONTRIBUTING.md](CONTRIBUTING.md) for the full contributor workflow. If you are an AI implementation agent (Codex, Jules), read [AGENTS.md](AGENTS.md) first, then use the [AI Build Guide](docs/tutorials/AI_BUILD_GUIDE.md) for a Codex CLI-oriented execution loop.
