...
| End-to-end UX confidence | Improving *(qualitative)* | Tracked via editor smoke workflows, `perl-lsp-ux-tests` first-5-minutes scenarios, and known-gap burn-down in this README; this is a directional signal, not a single KPI | Anything about parser breadth, protocol catalog size, or capability count |
