...
**Other editors** — download a prebuilt binary from [GitHub Releases](https://github.com/EffortlessMetrics/perl-lsp/releases), add it to your `PATH`, then point your LSP client at it (including Roo Code via `perllsp --stdio`; see [Roo Code setup](docs/EDITORS/ROO_CODE_SETUP.md)):
