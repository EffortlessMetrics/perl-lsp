...
```text
# JetBrains (IntelliJ IDEA / PhpStorm / WebStorm / RustRover)
# Configure a generic LSP server command as:
perllsp --stdio
```

For full JetBrains steps, see [docs/EDITORS/JETBRAINS_SETUP.md](docs/EDITORS/JETBRAINS_SETUP.md).
