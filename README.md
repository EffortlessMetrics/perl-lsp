...
| End-to-end UX confidence | *qualitative* | Tracked through manual editor smoke workflows, the `perl-lsp-ux-tests` first-5-minutes harness, and open-issue burn-down; no single aggregate score is published yet | Anything about parser breadth, protocol catalog size, or capability count |
