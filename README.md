...
**VS Code / Kilo Code** — install the extension and you are done:

For Kilo Code, install the same extension from Open VSX (`EffortlessMetrics.perl-lsp-rs`) and keep the default auto-download enabled.
## What It Is
