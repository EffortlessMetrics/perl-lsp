...
See [CONTRIBUTING.md](CONTRIBUTING.md) for the full contributor workflow. If you are an AI implementation agent (Codex, Jules, Aider), read [AGENTS.md](AGENTS.md) first. Aider users can run with repository defaults via `.aider.conf.yml`.
