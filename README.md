...
See [CONTRIBUTING.md](CONTRIBUTING.md) for the full contributor workflow. If you are an AI implementation agent (Codex, Jules, Gemini CLI), read [AGENTS.md](AGENTS.md) first. Tool-specific guidance for Gemini CLI is in [GEMINI.md](GEMINI.md).
