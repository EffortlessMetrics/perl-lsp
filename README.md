...
**Other editors** (Neovim, Emacs, Helix, Sublime, Eclipse, or any LSP client) — download a prebuilt binary from [GitHub Releases](https://github.com/EffortlessMetrics/perl-lsp/releases), add it to your `PATH`, then point your LSP client at it:
