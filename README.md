...
| Contributing with Codex CLI | [docs/how-to/CODEX_CLI.md](docs/how-to/CODEX_CLI.md) |
See [CONTRIBUTING.md](CONTRIBUTING.md) for the full contributor workflow. If you are using Codex CLI, start with [docs/how-to/CODEX_CLI.md](docs/how-to/CODEX_CLI.md). If you are an AI implementation agent (Codex, Jules), read [AGENTS.md](AGENTS.md) first.
