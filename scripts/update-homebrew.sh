...
SUMS_URL="https://github.com/EffortlessSteven/tree-sitter-perl/releases/download/${VERSION}/SHA256SUMS"
...
class PerlLsp < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/EffortlessSteven/tree-sitter-perl/releases/download/${VERSION}/perl-lsp-v${VERSION_NUM}-aarch64-apple-darwin.tar.gz"
      sha256 "${SHA_AARCH64_DARWIN}"
    else
      url "https://github.com/EffortlessSteven/tree-sitter-perl/releases/download/${VERSION}/perl-lsp-v${VERSION_NUM}-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/EffortlessSteven/tree-sitter-perl/releases/download/${VERSION}/perl-lsp-v${VERSION_NUM}-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "${SHA_AARCH64_LINUX}"
    else
      url "https://github.com/EffortlessSteven/tree-sitter-perl/releases/download/${VERSION}/perl-lsp-v${VERSION_NUM}-x86_64-unknown-linux-gnu.tar.gz"
