...
def build_replacements(
    ...
    return {
        ...
        "__PACKAGE_DESCRIPTION_LINE_1__": "perl-lsp is a public-alpha Perl language server written in Rust.",
        "__PACKAGE_DESCRIPTION_LINE_2__": "This package installs the perllsp and perl-dap executables from the public-alpha release artifact.",
